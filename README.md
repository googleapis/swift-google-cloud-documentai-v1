# Google Cloud Client Libraries for Swift - Cloud Document AI API
...
Add `swift-google-cloud-documentai-v1` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-documentai-v1.git --from 0.0.0-preview
```

Then add `GoogleCloudDocumentAIV1` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudDocumentAIV1 <target-name> --package swift-google-cloud-documentai-v1
```
